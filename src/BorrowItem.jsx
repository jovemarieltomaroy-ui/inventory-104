...
const BorrowItem = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const refRes = await fetch('https://inventory-backend-yfyn.onrender.com/api/inventory/references');
  ...
  const handleConfirm = async () => {
    ...
    try {
        const response = await fetch('https://inventory-backend-yfyn.onrender.com/api/borrowing', {
            method: 'POST',
